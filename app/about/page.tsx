...
const AboutPage = () => {
  return (
    ...
    <div className='flex flex-row'>
      <h1 className='mx-auto text-center text-[#425E5B] font-bold font-mono mb-6 text-3xl'>WE PUT OUR CUSTOMERS NEEDS FIRST</h1>

      <div className='text-[#425E5B]'>
        <h2 className='font-bold text-2xl font-mono'>OUR VISION</h2>
